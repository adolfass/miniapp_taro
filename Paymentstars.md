...
Экран выбора таролога (новый экран поверх основного, стилизован под общий дизайн: фиолетовый фон, золотые акценты).
...
Модальное окно подтверждения (появляется после нажатия «Выбрать»):
