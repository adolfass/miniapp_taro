...
export const majorArcana = [
  {
    ...
    arcana: "major",
    image: "00-fool.webp",
    description: "Новое начало, спонтанность, вера в лучшее. Призыв довериться миру и сделать шаг в неизвестность.",
  ...
  },
  {
    ...
    description: "Сила воли, мастерство, проявление желаний. У вас есть все ресурсы для достижения цели.",
  ...
  },
  {
    ...
    description: "Интуиция, тайные знания, внутренний голос. Прислушайтесь к своей интуиции.",
